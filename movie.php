...
<body>
    ...
    <div class="container">
        <div class="box">
            <img src="/OVAN/images/images1/inception/inception_main.jpg" width="300px" height="400px">
            <br>
            <a href="movie1.html">
        ...
        <div class="box">
            <img src="/OVAN/images/images1/avengers infity war/avengers_main.jpg" width="300px" height="400px">
            <br>
            <a href="/OVAN/movie2.php">
                <button id="btn" type="button" style="background:gold" >MORE INFO</button>
            </a>
        </div>
        <div class="box">
            <img src="/OVAN/images/images1/john wick 2/johnwick_main.jpg" width="300px" height="400px">
            <br>
            <a href="/OVAN/movie3.php">
                <button id="btn" type="button" style="background:gold" >MORE INFO</button>
            </a>
        </div>
        <div class="box">
            <img src="/OVAN/images/images1/fast and furious/fast&furious_main.webp" width="300px" height="400px">
            <br>
            <a href="/OVAN/movie4.php">
                <button id="btn" type="button" style="background:gold" >MORE INFO</button>
            </a>
        </div>
        <div class="box">
            <img src="/OVAN/images/images1/spiderman_no way home/spiderman_main.jpg" width="300px" height="400px">
            <br>
            <a href="/OVAN/movie5.php">
                <button id="btn" type="button" style="background:gold" >MORE INFO</button>
            </a>
        </div>
    </div>
